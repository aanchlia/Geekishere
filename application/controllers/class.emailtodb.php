...
class EMAIL_TO_DB {
 ...
 function connect($host, $port, $login, $pass){
  ...
  $this->link = imap_open("{imap.gmail.com:993/imap/ssl/novalidate-cert/norsh}Inbox", $login, $pass);
  if($this->link) {
  ...
  function set_path(){
      ...
      $this->file_path = "/var/www/"; #Where to write file attachments to //
 ...
 */
  ...
  function do_action(){
      ...
      //print_r($body); exit;
      //$s = imap_fetchstructure($this->link,vd fc$result[0]);
